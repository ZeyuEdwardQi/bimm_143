...
The data for our hands-on session comes from GEO entry: GSE37704, which
...
```
    ...
    Info: Working in directory /Users/edwardqi/Desktop/BIMM 143/bimm_143_github/class14
...
Cell cycle has the most significant Entities p-value. Some significant
pathways match with previous KEGG results. Differences can happen
because KEGG and Reactome define pathways differently, include different
genes, use different pathway sizes, and may apply different enrichment
statistics or p-value correction methods.
